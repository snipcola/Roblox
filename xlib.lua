...
local function CreateFakeScript(Func) coroutine.wrap(Func)() end
local XLib = {
  CreateAlert = function(Info)
          ...
          Button1.MouseEnter:Connect(function()
            inputEndedConnection = Button1.InputEnded:Connect(function(input)
              if input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                local tweenSize = tweenService:Create(XAlert, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Size = UDim2.new(0, 0, 0, 0) })
    ...
    CreateFakeScript(function() -- XAlert.DragScript
      ...
      local function Drag()
        ...
        TweenService:Create(Frame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Position = UDim2.new(0, Mouse.X - Frame.AbsolutePosition.X / Frame.AbsoluteSize.X, 0, Mouse.Y - Frame.AbsolutePosition.Y / Frame.AbsoluteSize.Y, 0) }):Play()
      end
    ...
    CreateFakeScript(function() -- XAlert.TweenScript
      ...
      local tweenSize = tweenService:Create(parent, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Size = UDim2.new(0, originalGuiSize.X, 0, originalGuiSize.Y) })
  ...
  CreateNotification = function(Info)
    ...
    if Info then
      ...
      coroutine.wrap(function()
        ...
        local tweenService = game:GetService("TweenService")
        local tweenSize = tweenService:Create(XNotification, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Size = UDim2.new(0, 0, 0, 0) })
